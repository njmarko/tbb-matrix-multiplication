...
MullTask::MullTask(const MyMatrix & _m1, const MyMatrix & _m2, MyMatrix & _m3, const int _rows_m1, const int _cols_m1, const int _rows_m2, const int _cols_m2)
...
{
	//MyMatrix* m1 = &a->getData();
	//MyMatrix* m2 = &b->getData();
	//MyMatrix* m3 = &c->getData();
