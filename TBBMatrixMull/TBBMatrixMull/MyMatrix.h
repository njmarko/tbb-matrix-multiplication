...
* @param m1 const reference to the first input matrix
* @param m2 const reference to the second input matrix
* @param m3 const reference to the output matrix
* @param rows_m1 number of rows in the first input matrix
* @param cols_m1 number of cols in the first input matrix
* @param rows_m2 number of rows in the second input matrix
* @param cols_m2 number of cols in the second input matrix
*/
...
* @param matrix_sizes const reference to a vector that holds matrix dimensions
*/
...
struct InvalidData : public MatrixException {
	...
	* @param filename name of the file where the data was invalid
	*/
